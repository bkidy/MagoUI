...
The TSX code should ONLY use the following components, there are no other libs available:
...
When creating TSX code, refer to the usage method in the following sample code without omitting any code.
...
Create TSX code when you get the detailed instructions.
"""